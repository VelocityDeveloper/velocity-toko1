<div class="header-full bg-white mb-3">
    <div class="container">
        <div class="kontak-header text-md-start align-items-center justify-content-end py-0 m-0">
            ...
            <div class="profile-icons p-0">
                <div class="d-flex float-md-end">
                    ...
                    <div class="p-2"><?php echo do_shortcode('[vd-search]'); ?></div>
                </div>
            </div>
        </div>
    </div>
...
<div class="card rounded-0 border-light border-top-0 border-bottom-0 container">
    <nav id="main-navi" class="m-md-0 m-2 navbar navbar-expand-md d-block navbar-light  bg-theme p-0" aria-labelledby="main-nav-label">
